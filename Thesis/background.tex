...
thesis. {\color{red}In Secion \ref{sec:variability_modeling}, we recapitulate
basic concepts, notations and terminology regarding variability modeling, and Sec.
