...
\begin{itemize}
  \item Separation of concerns as a driving motivation for variability;
  different types of separation (physical or virtual) \citep{kastner_model_2009}
  and accomodation of variability (load-time or compile-time)
  \citep{apel_feature-oriented_2013}
  \item Why reverse engineering variability is useful and necessary
  ((variability-aware) analysis, required for configuration)
\end{itemize}

\subsection{Reverse Engineering Configurable Software Systems}
\begin{itemize}
  \item Reverse engineering, or extracting a model of how variability is
  integrated in a configurable software system
  \item Useful to run variability-aware analyses on it, such as \cite{meinicke_essential_2016}
  \item Variational DOM \cite{nguyen_building_2014}
  \item Mapping of code segments to conditions \cite{lillack_tracking_2014}
  \item Variability-aware parsing \cite{kastner_variability-aware_2011}
\end{itemize}
