...
presented, however, are rathe isolated solutions due to non-generic
...
\begin{itemize}
  \item \emph{How is variability implemented?} Variability can be acommodated at
...
sythesizing a variability model is to answer the the questions above manually,
